...
function LightSwitch(props) {
  ...
  return (  
    <div style={{background : bgColor, color: textColor, padding: '7em 10em 10em 15em', border: 'solid black 3px',  
    borderRadius: '5px'}}>
      <button style={{fontSize: '3em', fontWeight: 'bold', border: 'solid #A9A9A9 5px', color: 'white', backgroundColor: '#800000', borderRadius: '5px', padding: '15px 15px 15px 15px'}}onClick={handleLightSwitchClick}>
        {state}
      </button>
    </div>
  )
